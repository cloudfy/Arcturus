...
//    internal const HttpStatusCode _defaultStatusCode = HttpStatusCode.BadRequest;
...
//            statusCode = result.HttpStatusCode.Value;

//        problemDetails.Extensions[timestampKey] = DateTime.UtcNow;
//        problemDetails.Instance ??= $"{httpContext.Request.Method} {httpContext.Request.Path}";
//        problemDetails.Type ??= $"https://schemas/2022/fault/#{statusCode}";
