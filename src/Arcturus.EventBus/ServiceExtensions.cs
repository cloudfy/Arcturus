...
public static class ServiceExtensions
{
    ...
    {
        // Populate registry and register handlers
        // Note: Logger is not available during service configuration
        // Logging will occur when handlers are actually invoked
        builder.PopulateEventRegistry(logger: null);
