...
[![NuGet](https://img.shields.io/nuget/dt/Arcturus.Repository.EntityFrameworkCore.InMemory.svg)](https://www.nuget.org/packages/Arcturus.Repository.EntityFrameworkCore.InMemory) 
[![NuGet](https://img.shields.io/nuget/vpre/Arcturus.Repository.EntityFrameworkCore.InMemory.svg)](https://www.nuget.org/packages/Arcturus.Repository.EntityFrameworkCore.InMemory)
...
```bash
dotnet add package Arcturus.Repository.EntityFrameworkCore.InMemory
```

Or, using the Package Manager Console:

```powershell
Install-Package Arcturus.Repository.EntityFrameworkCore.InMemory
```
